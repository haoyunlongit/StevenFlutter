            ...
            child: BlurRectWidget(
              Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'A widget that applies a filter to the existing painted content and then paints child. the existing painted content and then paints child. the existing painted content and then paints child. the existing painted content and then paints child. the existing painted content and then paints child. the existing painted content and then paints child.'
